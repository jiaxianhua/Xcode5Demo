...
- (void)viewDidLoad
{
    ...
    _array = [NSArray arrayWithObjects:@"January", @"February", @"March", @"April", @"May", @"June", @"July", @"August", @"September", @"October", @"November", @"December", nil];
    ...
    // 初始化NSIndexPath对象，指定UITableView滑动到目标位置。
